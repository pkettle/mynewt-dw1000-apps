...
static int madhu(uint16_t conn_handle, uint16_t attr_handle, struct ble_gatt_access_ctxt *ctxt, void *arg);
...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    {
        ...
        .characteristics = (struct ble_gatt_chr_def[]) { {
                ...
                .uuid = BLE_UUID16_DECLARE(0xa5a5),
                .access_cb = madhu,
                .flags = BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_RELIABLE_WRITE | BLE_GATT_CHR_F_READ,
            }, {
