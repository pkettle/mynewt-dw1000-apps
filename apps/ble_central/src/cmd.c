...
{
    char arg1[] = "disconnect";
    char arg2[5];
    sprintf(arg2,"conn=%d",conn);
    char *argv[2];
    argv[0] = arg1;
    argv[1] = arg2;
   return cmd_disconnect(2,&argv[0]);
}
*/
static int
...
{
     char arg1[] = "set";
     char arg2[] = "addr_type=public";
     char arg3[] = "addr=01:02:03:04:05:06";
     char *argv[3];
     argv[0] = arg1;
     argv[1] = arg2;
     argv[2] = arg3;
     return cmd_set(3,&argv[0]);
}
